...
export class MealsComponent implements OnInit {
  ...
  constructor(public service: MealsService, public loginService:LoginService) {
    /**
     ...
     */
    this.service.getChildrenByParent(this.loginService.idParentLogged)
      .then(() => this.service.getMealsByParentId(this.loginService.idParentLogged))
